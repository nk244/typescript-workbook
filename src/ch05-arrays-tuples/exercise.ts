 ...
 * ROLES の中身は書き換えないこと。
 * ============================================================ */
export const ROLES = ['admin', 'editor', 'viewer']; // TODO: as const をつける

export type Role = unknown; // TODO: ROLES から導く（手で 'admin' | ... と書かないこと）
...
export type LogLevelValue = unknown; // TODO
