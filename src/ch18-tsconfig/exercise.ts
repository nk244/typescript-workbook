...
export const Q1: CompilerOption = 'noImplicitAny'; // TODO

/* 18-2  function f(x) { return x * 2; }  引数の型を書き忘れた。防ぐのは？ */
export const Q2: CompilerOption = 'noImplicitAny'; // TODO

/* 18-3  const first = items[0]; first.toUpperCase();  空配列だと落ちる。防ぐのは？ */
export const Q3: CompilerOption = 'noImplicitAny'; // TODO

/* 18-4  catch (e) { console.log(e.message); }  e が Error とは限らない。防ぐのは？ */
export const Q4: CompilerOption = 'noImplicitAny'; // TODO

/* 18-5  親のメソッドを上書きしたつもりが綴り違いだった。防ぐのは？ */
export const Q5: CompilerOption = 'noImplicitAny'; // TODO

/* 18-6  switch の break 忘れを防ぐのは？ */
export const Q6: CompilerOption = 'noImplicitAny'; // TODO

/* 18-7  class User { name: string; } を初期化しないまま使うのを防ぐのは？ */
export const Q7: CompilerOption = 'noImplicitAny'; // TODO

/* 18-8  型としてしか使っていない import が実行時に残るのを防ぐのは？ */
export const Q8: CompilerOption = 'noImplicitAny'; // TODO
...
export const CONFIRMED_INDEXED_ACCESS = false; // TODO
